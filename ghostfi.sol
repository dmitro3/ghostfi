...
contract GhostFi is Ownable {
    ...
    function buyGhost(address sharesSubject, uint256 amount) public payable {
    ...
    function sellGhost(address sharesSubject, uint256 amount) public payable {
        uint256 supply = sharesSupply[sharesSubject];
